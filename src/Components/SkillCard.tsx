...
const SkillBadge = (skills: []) => {
  return skills.map((skill: any, index: number) => (
    <div
      key={index}
      className="flex gap-2 border border-textColor rounded-2xl items-center py-2 px-3"
    >
      <Avatar
...
const SkillCard = (props: any) => {
  return (
    <div
      ...
      className="w-[49%] shadow-[0_0_10px_0_#64FFDA50] rounded-3xl  mb-3 border border-primaryColor p-5 "
    >
